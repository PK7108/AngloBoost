...
function getMetaTitle(lang) {
    const baseTitle = lang === 'pl'
        ? 'Jak pisać rozprawki po angielsku? Kompletny przewodnik'
        : 'How to Write Essays in English? Complete Guide'
...
function getMetaDescription(lang) {
    const baseDescription = {
        pl: 'Kompletny przewodnik po pisaniu rozprawek po angielsku. Naucz się struktur for and against essay oraz opinion essay. Zwroty, przykłady i techniki pisania.',
        en: 'Complete guide to writing essays in English. Learn structures for for and against essays and opinion essays. Phrases, examples and writing techniques.'
    }
...
function getCanonicalUrl(lang) {
    return lang === 'pl'
        ? 'https://angloboost.pl/pl/pisanie/jak-pisac-rozprawki'
        : 'https://angloboost.pl/en/writing/how-to-write-essays'
}
