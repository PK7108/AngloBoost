...
function getMetaTitle(lang) {
    const baseTitle = lang === 'pl'
        ? 'Jak pisać opowiadania po angielsku? Kompletny przewodnik'
        : 'How to Write Stories in English? Complete Guide'
...
function getMetaDescription(lang) {
    const baseDescription = {
        pl: 'Kompletny przewodnik po pisaniu opowiadań po angielsku. Naucz się tworzyć ciekawe i poprawne językowo historie. Struktura, czasy przeszłe, słownictwo, przykłady i wskazówki.',
        en: 'Complete guide to writing stories in English. Learn how to create interesting and linguistically correct stories. Structure, past tenses, vocabulary, examples and tips.'
    }
...
function getCanonicalUrl(lang) {
    return lang === 'pl'
        ? 'https://angloboost.pl/pl/pisanie/jak-pisac-opowiadania'
        : 'https://angloboost.pl/en/writing/how-to-write-stories'
}
