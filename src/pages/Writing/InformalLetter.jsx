...
function getMetaTitle(lang) {
    const baseTitle = lang === 'pl'
        ? 'Jak pisać nieformalne listy po angielsku? Kompletny przewodnik'
        : 'How to Write Informal Letters in English? Complete Guide'
...
function getMetaDescription(lang) {
    const baseDescription = {
        pl: 'Kompletny przewodnik po pisaniu nieformalnych listów po angielsku. Naucz się swobodnej korespondencji z przyjaciółmi i rodziną. Struktura, zwroty, przykłady i wskazówki.',
        en: 'Complete guide to writing informal letters in English. Learn how to write casual correspondence with friends and family. Structure, phrases, examples and tips.'
    }
...
function getCanonicalUrl(lang) {
    return lang === 'pl'
        ? 'https://angloboost.pl/pl/pisanie/jak-pisac-listy-nieformalne'
        : 'https://angloboost.pl/en/writing/how-to-write-informal-letters'
}
